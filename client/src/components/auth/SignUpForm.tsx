...
const SignUpForm = () => {
  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit}>
      <div className="group">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-10 pr-4 py-3 w-full rounded-sm border-2 border-gray-200 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-200 bg-gray-50/50 hover:bg-white focus:bg-white"
      ...
      {
        error && <p className="text-red-600 text-sm font-medium w-full text-center ">{error}</p>
      }

      <button
        type="submit"
        disabled={loading}
        className="w-full py-3 px-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-sm hover:from-blue-700 hover:to-blue-800 focus:ring-4 focus:ring-blue-500/25 transform hover:scale-[1.02] transition-all duration-200 shadow-lg hover:shadow-xl"
      >
        {
